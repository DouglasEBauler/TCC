...
public class RenderController : MonoBehaviour 
{
    ...
    public static void ResizeBases(GameObject baseRender, string tipoPeca, bool incrementa, bool tutorial = false)
    {
        ...
        {
            //otherBase = GameObject.Find("BaseRenderLateral" + ((!tutorial) ? DropPeca.countObjetosGraficos.ToString() : "Tutorial"));
            //otherBase.SetActive(true); //Base lateral cinza

            //otherBase = GameObject.Find("BaseObjetoGrafico" + ((!tutorial) ? DropPeca.countObjetosGraficos.ToString() : "Tutorial"));
            //otherBase.SetActive(true); //Base objeto gráfico verde
        }
