...
public class PropCameraScript : MonoBehaviour
{
    ...
    public void PreencheCampos()
    {
        ...
        camFOV.text = Global.propCameraGlobal.FOV.Equals(0) ? "45" : Global.propCameraGlobal.FOV.ToString();
    ...
    void EnableEixoZ()
    {
        ...
        labelfov.transform.localPosition =
            new Vector3(labelfov.transform.localPosition.x, Global.Grafico2D ? 0.110f : 0, Global.Grafico2D ? 50 : -2.999623f);
    }
}
