...
public class PropIluminacaoPadrao : MonoBehaviour
{
    ...
    public void preencheCamposIluminacao(int iluminacao)
    {
        switch (iluminacao)
        {
            case 0: preencheCamposIluminacao(TipoIluminacao.Ambiente); break;
            case 1: preencheCamposIluminacao(TipoIluminacao.Directional); break;
            case 2: preencheCamposIluminacao(TipoIluminacao.Point); break;
            case 3: preencheCamposIluminacao(TipoIluminacao.Spot); break;
        }
    }
    ...
    public void instanciaTransformacao()
    {
        if (!Global.propriedadeIluminacao.ContainsKey(Global.gameObjectName))
        {
            ...
            {
                pecas[i] = new PropriedadePeca()
                {
                    Pos = new Posicao() { X = 100, Y = 300, Z = 0 },
                    ValorIluminacao = new ValorIluminacao() { X = 0, Y = 0, Z = 0 },
                    Cor = Color.white,
                    Ativo = true,
                    Intensidade = 1.5f,
                    Distancia = 1000,
    ...
    public string GetTipoLuzPorExtenso(int tipoLuz)
    {
        ...
        {
            case 0:
                tipoLuzExtenso = "Ambiente";
                break;
            case 1:
                tipoLuzExtenso = "Directional";
                break;
            case 2:
                tipoLuzExtenso = "Point";
                break;
            case 3:
                tipoLuzExtenso = "Spot";
                break;
    ...
    public void AtualizaCamera()
    {
        ...
        foreach (var dic in Global.propriedadeIluminacao)
        {
